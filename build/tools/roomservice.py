...
if not depsonly:
    print("Device %s not found. Attempting to retrieve device repository Github (http://github.com/X-ID-Rom)." % device)
...
if not depsonly:
    ...
    try:
        ...
        print(urllib.request.urlopen(githubreq).read().decode())
